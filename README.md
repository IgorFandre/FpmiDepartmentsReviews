...
5) [Кафедра интеллектуальных систем. Проектирование и организация систем (ВЦ РАН)](#кафедра-интеллектуальных-систем-проектирование-и-организация-систем-вц-ран)
6) [Кафедра информатики и выч. математики (МФТИ)](#кафедра-информатики-и-выч-математики-мфти)
7) [Кафедра когнитивных технологий (Smart Engines)](#кафедра-когнитивных-технологий-smart-engines)
8) [Кафедра корпоративных информационных систем (1С)](#кафедра-корпоративных-информационных-систем-1с)
9) [Кафедра мат. моделирования и прикладной мат. Мат. физика и мат. моделирование (ИПМ РАН)](#кафедра-мат-моделирования-и-прикладной-мат-мат-физика-и-мат-моделирование-ипм-ран)
10) [Кафедра проблем передачи информации и анализа данных (ИППИ)](#кафедра-проблем-передачи-информации-и-анализа-данных-иппи)
11) [Кафедра теор. и прикладной информатики (Киберпротект)](#кафедра-теор-и-прикладной-информатики-киберпротект)
12) [Кафедра финансовых технологий. Backend на Scala (Т-Банк)](#кафедра-финансовых-технологий-backend-на-scala-т-банк)
13) [Кафедра финансовых технологий. Продуктовая аналитика (Т-Банк)](#кафедра-финансовых-технологий-продуктовая-аналитика-т-банк)
14) [Современные образовательные технологии (ЦПиС ФПМИ)](#современные-образовательные-технологии-цпис-фпми)
...
3. **(2024)** Было одно собеседование, в ходе которого задавали вопросы по базам данных (ACID, транзакции), алгоритмам (рассказать про алгоритмы поиска кратчайших путей), была несложеная задача с литкода. Собес проводят в Сберджазе, так что нужно установить сертификаты Минцифры.
### Были ли на кафедре какие-то трудности, с которыми вы столкнулись во время обучения и о которых хотели бы узнать до поступления на кафедру? Если да, то какие?
...
3. **(2024)** Самая главная трудность - дорога. Все занятия проводятся очно в офисе Сбертеха по адресу Новоданиловская наб., 10к1. С кампуса примерно полтора часа пути.
### На чем вы специализируетесь? Какие дисциплины, связанные с вашей специализацией, Вы считаете наиболее интересными и полезными?
...
3. **(2024)** Backend (java+kotlin), ml Для бэка можно перечислить много дисциплин (Java, базы данных, сети, etc.), которые так или иначе будут полезны для работы в этой области. Для ml есть курс по машинке во втором семесте (по программе похож на курс Нейчева, но более углубленный). Про 3 семестр не знаю
### Какие главные положительные стороны Вы могли бы выделить у своей кафедры?
...
3. **(2024)** Бесплатный кофе😁 Веселые доброжелательные преподаватели
### Аналогичный вопрос про отрицательные стороны обучения на кафедре.
...
3. **(2024)** Заканчиваются сливки для кофе🥴 Долгая дорога до офиса, если ехать к первой паре - то это смэрть💀
### Если бы у Вас была возможность вернуться назад и снова выбрать кафедру, выбрали бы Вы ту же самую или что-то изменили? Если да, то по какой причине?
...
2. **(2023)** Нет
3. **(2024)** Все преподаватели молодые, веселые и энергичные
### Оцените в среднем работу преподавателей и опишите, что Вам нравится и что нет.
...
3. **(2024)** Да, помогает. В чат скидывают вакансии в Сбере и Сбертехе (хотя на эти ваканчии обычно уже нужен какой-то опыт). Также можно прислать резьме на кафедру с просьбой отправить его командам.
### Стипендия? (при каких условиях дается, сколько и т.п.)
1. **(2023)** Тут хз, вроде её нет
2. **(2023)** Закрываться без удов НА ПРЕДМЕТАХ КАФЕДРЫ - 10 тыс. рублей
3. **(2024)** Стипенлия 10000 при условии, что все кафедральные предметы закрыты на 7 и выше, и что все остальные предметы закрыты на 3 и выше (если по предмету получена пересдача, то для сохранения стипендии надо закрыть ее не хуже чем на 10)
## Про науку.

### Насколько по Вашему мнению кафедра поощрает научные работы студентов? Склонны ли преподаватели помогать студентам? Предоставляет ли кафедра необходимое оборудование (или что-либо необходимое для реализации научной работы)?
1. **(2023)** Кафедра крайне заинтересована в научной работе
2. **(2023)** Поощряет, в самом сбере есть специальные научные отделы
3. **(2024)** На кафедре много преподавателей, готовых писать статьи и научные работы со студентами
### Как происходил выбор научрука? Помогала ли кафедра в этом или всё лежало на Ваших плечах. Была ли свобода действий в поиске, т. е. можно ли было искать руководителя, к примеру, вне кафедры?
...
3. **(2024)** В конце первого семестра на почты рассылаются списки научруков с темами, которые они предлагают. Также можно выбрать свою тему и своего научнука.
### Какие дополнительные возможности (проекты, исследования, конференции и т.д.) предоставляет ваша кафедра для студентов?
...
3. **(2024)** Есть магистратура Сбера
## Индустрия.
...
2. **(2024)** Зависит от курса. На некоторых практики не было вообще, на других - достаточно для усвоения материала
### Есть ли возможность работать, обучаясь на кафедре? Сколько часов можно уделять работе?
1. **(2023)** Да, есть. Можно хоть 40.
2. **(2024)** Возможность работать есть. Пары компануются так, чтобы все они проходили в один день, поэтому на остальные дни можно брать работу
## Другое.
