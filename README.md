...
3. **(2024)** Учитывался ли средний балл - не помню СРедний балл у меня был в районе 8.5 Больше всего повлияло, что это кафедра от бигтеха + эта кафедра халявная
### Были ли на кафедре какие-то трудности, с которыми вы столкнулись во время обучения и о которых хотели бы узнать до поступления на кафедру? Если да, то какие?
1. **(2024)** нет
### На чем вы специализируетесь? Какие дисциплины, связанные с вашей специализацией, Вы считаете наиболее интересными и полезными?
...
3. **(2024)** На кафедре был курс по мат стату - но у меня уже был курс по мат стату на дс потоке, и курс дс потока был намного сильнее. Так что это был бесполезный курс, благо хотя бы домашки было мало Ещё был курс по фин матеше - это было что-то новое и относительно полезное для меня
### Какие главные положительные стороны Вы могли бы выделить у своей кафедры?
...
3. **(2024)** Убогое приложение для заочного присутствия на лекциях. В тиньке отказались от зум в пользу своего недоделанного приложения
### Если бы у Вас была возможность вернуться назад и снова выбрать кафедру, выбрали бы Вы ту же самую или что-то изменили? Если да, то по какой причине?
...
3. **(2024)** выбрал бы ту же кафедру
### Влияет ли в Вашей отрасли возраст преподавателей на качество материала? Если да, то расскажите в какую сторону и как это проявляется на Вашей кафедре.
...
3. **(2024)** нет, хотя и все преподы относительно молодые
### Оцените в среднем работу преподавателей и опишите, что Вам нравится и что нет.
...
3. **(2024)** По мат стату - я не слушал, так что не могу судить По фин (финансовой) матеше - препод не совсем четко ведёт лекцию, но зато есть конспект, который это компенсирует
### Помогает ли кафедра в устройстве на работу, поиске стажировок (в том числе и зарубежных)?
...
3. **(2024)** Да, тиньк берёт к себе на работу
### Стипендия? (при каких условиях дается, сколько и т.п.)
1. **(2022)** Нет.
2. **(2022)** Нет
3. **(2024)** не интересовался
## Про науку.
...
3. **(2024)** Научрука ещё не выбирал
### Какие дополнительные возможности (проекты, исследования, конференции и т.д.) предоставляет ваша кафедра для студентов?
1. **(2024)** без понятия
### Какие перспективы дальнейшего обучения (магистратура, аспирантура) или карьеры открываются перед студентами кафедры?
...
3. **(2024)** Точно есть магистратура, про аспирантуру не знаю
### Существует ли взаимодействие кафедры с иностранными коллегами? Если да, то в каком формате?
1. **(2024)** о таком не слышал
## Индустрия.

### Насколько много практики на кафедре?
1. **(2022)** Нет её
2. **(2022)** Дз все практические, это круто, можно сразу применять в работе
3. **(2024)** немного - то что и нужно для халявы
### Есть ли возможность работать, обучаясь на кафедре? Сколько часов можно уделять работе?
...
3. **(2024)** Совмещать работу и учёбу ещё не пробовал, но это из-за ДС потока А так думаю 30 часов работы можно совмещать
## Другое.
...
2. **(2024)** Тиньк - хорошая кафедра лдя халявщиков (и тех кому интересны финансы хотя бы из любопытства)
